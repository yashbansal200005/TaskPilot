...
const AdminLogin = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#F0FDF4]">
      ...
      >
        <h2 className="text-3xl font-bold text-[#333333] text-center">Admin Login</h2>
        ...
        <p className="text-sm text-center text-[#333333]">
          ...
          <Link to="/admin/register" className="text-[#93C5FD] hover:underline">
            Register
          </Link>
        </p>

        <div className="text-center">
          <Link to="/" className="text-[#333333] text-sm hover:underline">
            ⬅️ Back to Home
          </Link>
        </div>
      </form>
